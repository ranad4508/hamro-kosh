        ...
        children: [
          Form(
            ...
            child: Column(
              ...
              children: [
                Text('New announcement', style: Theme.of(context).textTheme.titleSmall),
                ...
                const SizedBox(height: AppSpacing.sm),
                AppButton(label: 'Publish', isLoading: _sending, onPressed: _publish),
              ],
            ),
          ),
          const SizedBox(height: AppSpacing.xl),
          Text('Published announcements', style: Theme.of(context).textTheme.titleSmall),
          const SizedBox(height: AppSpacing.sm),
          announcements.when(
            ...
            data: (items) {
              if (items.isEmpty) {
                return const EmptyState(icon: Icons.campaign_outlined, title: 'None published yet');
              }
              return Column(
                children: [
